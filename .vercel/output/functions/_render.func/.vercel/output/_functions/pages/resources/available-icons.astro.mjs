...
const $$IconCard = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<div class="bg-gradient-to-r from-primary/50 to-secondary/50 appearance-none rounded-lg p-px"> <div class="flex flex-col gap-2 items-center bg-neutral-100/90 text-neutral-500 rounded-lg p-4"> ${renderSlot($$result, $$slots["default"])} </div> </div>`;
}, "/Users/hariomharsh/Developer/Loader Docs/src/components/IconCard.astro", void 0);

const $$Astro = createAstro();
const $$AvailableIcons = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$AvailableIcons;
  const exampleCode = `
<Icon icon="star" class="custom-class" />
`;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Free Astro Components - Available Icons", "data-astro-cid-demfrip6": true }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Header", $$Header, { "data-astro-cid-demfrip6": true })} ${renderComponent($$result2, "Sidebar", $$Sidebar, { "data-astro-cid-demfrip6": true })} ${renderComponent($$result2, "Content", $$Content, { "data-astro-cid-demfrip6": true }, { "default": ($$result3) => renderTemplate` ${maybeRenderHead()}<section data-astro-cid-demfrip6> ${renderComponent($$result3, "Article", $$Article, { "data-astro-cid-demfrip6": true }, { "default": ($$result4) => renderTemplate`  ${renderComponent($$result4, "Prose", $$Prose, { "data-astro-cid-demfrip6": true }, { "default": ($$result5) => renderTemplate` ${renderComponent($$result5, "Text", $$Text, { "data-astro-cid-demfrip6": true }, { "default": ($$result6) => renderTemplate`
Welcome to the icon library. Below, you'll find a list of all
            ...
            be selected by using its name in the <code data-astro-cid-demfrip6>icon</code> attribute of the
            component.
` })} ${renderComponent($$result5, "CodeBlock", $$CodeBlock, { "lang": "astro", "code": exampleCode, "data-astro-cid-demfrip6": true })} ` })} ${renderComponent($$result4, "Prose", $$Prose, { "data-astro-cid-demfrip6": true }, { "default": ($$result5) => renderTemplate` ${renderComponent($$result5, "Heading", $$Heading, { "level": 2, "text": "Icon List", "data-astro-cid-demfrip6": true })} <ul class="flex flex-col gap-8" data-astro-cid-demfrip6> ${iconsCategories.map((category) => {
    const categoryIcons = icons.filter(
      (icon) => icon.category === category
    );
    return categoryIcons.length > 0 ? renderTemplate`<li class="flex flex-col gap-4" data-astro-cid-demfrip6> ${renderComponent($$result5, "Heading", $$Heading, { "level": 5, "text": category, "class": "capitalize", "data-astro-cid-demfrip6": true })} <ul class="icons-list" data-astro-cid-demfrip6> ${categoryIcons.map((icon) => renderTemplate`<li data-astro-cid-demfrip6> ${renderComponent($$result5, "IconCard", $$IconCard, { "data-astro-cid-demfrip6": true }, { "default": ($$result6) => renderTemplate` ${renderComponent($$result6, "IconAc", $$Icon, { "icon": icon.name, "class": "w-8 h-8 text-primary", "data-astro-cid-demfrip6": true })} <span class="text-neutral-500 text-sm" data-astro-cid-demfrip6> ${icon.name} </span> ` })} </li>`)} </ul> </li>` : null;
  })} </ul> ` })} ${renderComponent($$result4, "Prose", $$Prose, { "data-astro-cid-demfrip6": true }, { "default": ($$result5) => renderTemplate` ${renderComponent($$result5, "Heading", $$Heading, { "level": 2, "text": "Using Icons", "data-astro-cid-demfrip6": true })} ${renderComponent($$result5, "Text", $$Text, { "data-astro-cid-demfrip6": true }, { "default": ($$result6) => renderTemplate`
To learn more about how to use these icons in your components,
            including customization options, please refer to the ${renderComponent($$result6, "Link", $$Link, { "href": "/components/icon", "data-astro-cid-demfrip6": true }, { "default": ($$result7) => renderTemplate`Icon Component Documentation.` })} ` })} ` })} ${renderComponent($$result4, "Prose", $$Prose, { "data-astro-cid-demfrip6": true }, { "default": ($$result5) => renderTemplate` ${renderComponent($$result5, "Heading", $$Heading, { "level": 2, "text": "Note", "data-astro-cid-demfrip6": true })} ${renderComponent($$result5, "List", $$List, { "data-astro-cid-demfrip6": true }, { "default": ($$result6) => renderTemplate` ${renderComponent($$result6, "ListItem", $$ListItem, { "data-astro-cid-demfrip6": true }, { "default": ($$result7) => renderTemplate` ${renderComponent($$result7, "Text", $$Text, { "data-astro-cid-demfrip6": true }, { "default": ($$result8) => renderTemplate` <strong data-astro-cid-demfrip6>Icon Name</strong>: Use the <code data-astro-cid-demfrip6>icon</code> attribute with
                the icon name (e.g., <code data-astro-cid-demfrip6>icon="star"</code>) to display the
                desired icon.
` })} ` })} ${renderComponent($$result6, "ListItem", $$ListItem, { "data-astro-cid-demfrip6": true }, { "default": ($$result7) => renderTemplate` ${renderComponent($$result7, "Text", $$Text, { "data-astro-cid-demfrip6": true }, { "default": ($$result8) => renderTemplate` <strong data-astro-cid-demfrip6>Customization</strong>: ou can style the icons using CSS
                classes, such as <code data-astro-cid-demfrip6>custom-class</code>, to adjust size and
                color.
` })} ` })} ` })} ` })} `, "header": ($$result4) => renderTemplate`${renderComponent($$result4, "Heading", $$Heading, { "slot": "header", "level": 1, "gradient": true, "class": "inline-block", "text": "Available Icons", "data-astro-cid-demfrip6": true })}` })} </section> ` })}  ` })}`;
}, "/Users/hariomharsh/Developer/Loader Docs/src/pages/resources/available-icons.astro", void 0);

const $$file = "/Users/hariomharsh/Developer/Loader Docs/src/pages/resources/available-icons.astro";
const $$url = "/resources/available-icons";
